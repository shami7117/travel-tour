                ...
                <div className='flex '>
                    ...
                    <div className='flex justify-between w-full p-2 md:p-0 md:mx-[100px] mt-5 md:mt-[70px]'>
                        <div className=' flex flex-col'>
                            <p className='z-[2] relative text-[24px] md:text-[40px] font-Oswald font-bold'>Trending Now</p>
                            <img src="Trending.svg" alt="" className='w-[130px] md:h-auto md:w-auto inline absolute top-[21px]' />
