...
import Essencecards from './Essencecards';
                ...
                <div className='flex '>
                    ...
                    <div className='flex justify-between w-full p-2 md:p-0 md:mx-[100px] mt-5 md:mt-[70px]'>
                        <div className=' flex flex-col'>
                            <p className='z-[2] relative text-[24px] md:text-[40px] font-Oswald font-bold'>Choose Your Essence</p>
                            <img src="Essence.svg" alt="" className='md:h-auto md:w-auto w-[210px] inline absolute top-[15px]' />
                ...
                <div className=' md:mx-[100px] flex flex-col'>
                    ...
                    {isMobile ? (
                        <div className='flex flex-col mt-4  gap-y-[20px] mx-auto  '>
                            <Essencecards headingis="Hills & Mountains" />
                            <Essencecards headingis="Beaches & Backwaters" />
                            <Essencecards headingis="Wildlife & Wilderness" />
                            <Essencecards headingis="Adventure" />
                            <Essencecards headingis="Hills & Mountains" />
                            <Essencecards headingis="Beaches & Backwaters" />
